...
export const api = {
  ...
  dealer: {
    ...
    riskQuestionGroups: {
      ...
      create:      (data: any)                                     => post<RiskQuestionGroup>("/dealer/risk-question-groups", data),
      update:      (id: string, data: any)                         => put<RiskQuestionGroup>(`/dealer/risk-question-groups/${id}`, data),
      remove:      (id: string)                                    => del(`/dealer/risk-question-groups/${id}`),
